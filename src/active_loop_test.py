...
for model_path in model_path_list:
    ...
    shutil.move(os.path.join(inference_output_dir, 'coco_instances_results.json'), os.path.join(inference_output_dir, f"coco_instances_results_{model_path.split(".")[0]}.json"))
